        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-center min-h-screen">
          ...
          <div className="text-center">
            <div className="cool-split mb-12">
              ...
              >
                &ldquo;At Binary Brains, we specialize in turning ideas into
                impactful digital solutions. Our team blends creativity with
                cutting-edge technology to design and build software that drives
                innovation, accelerates growth, and empowers businesses to
                thrive in the digital era.&rdquo;
              </h2>
            </div>
            ...
            <div className="subtitle-text opacity-0">
              <p className="text-sm sm:text-base md:text-lg text-zinc-400 max-w-3xl mx-auto mb-8">
                At Binary Brains, we combine creativity and technology to build
