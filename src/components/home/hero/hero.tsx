...
const page = () => {
  return (
    <div className='w-full h-screen flex flex-col justify-center items-center relative selection:bg-white selection:text-black overflow-hidden' id='home'>
      ...
      <div className='md:hidden w-full h-screen flex flex-col items-center justify-center relative z-20 px-4 text-center'>
        ...
        <div className='mb-6'>
          <div className='text-4xl font-medium leading-[0.9] text-white'>
            YOUR <span className='gradient-text inline-block relative border border-zinc-600 rounded px-2 py-1 ml-1'>IDEA</span>
          </div>
        </div>
        ...
        <div className='mb-12'>
          <div className='text-4xl font-medium leading-[0.9] text-white'>
            OUR <span className='gradient-text inline-block relative border border-zinc-600 rounded px-2 py-1 ml-1'>SOLUTIONS</span>
          </div>
        </div>
      ...
      <div className='hidden md:flex w-full h-screen items-center justify-center relative z-20'>
        <div className='w-full text-7xl sm:text-9xl md:text-8xl lg:text-[10rem] xl:text-[5rem] leading-[0.8] sm:leading-[0.8] md:leading-[0.8] lg:leading-[0.8] xl:leading-[11rem] font-medium px-4 sm:px-6 text-zinc-200 flex items-center justify-between'>
          ...
          <span className='leading-[1] flex flex-col items-end text-right text-white'>
            <span className='flex items-center'>OUR <a className='text-lg text- bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-8 py-4 cursor-pointer' href='/contact'>GET IN TOUCH</a></span>
            <span className='gradient-text inline-block relative'>SOLUTIONS</span>
          </span>
        </div>
      </div>
      ...
      <style jsx>{`
        .gradient-text {
          background: linear-gradient(135deg, #1e3a8a, #103675, #0055bd, #174478, #1e3a8a);
