  ...
  return (
    <section className="relative w-full bg-white text-black">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-40 pb-16">
        {/* Giant Title */}
        <h1 className="select-none leading-none font-humane text-[20vw] sm:text-[16vw] md:text-[14vw] lg:text-[12vw] text-transparent -mt-6"
        style={{
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 -mt-10">
          ...
          <div className="z-10 space-y-8">
            <p className="max-w-md text-sm text-zinc-600">
              For any inquiries, collaborations, or just to say hello, we'd love to hear
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="mt-3 text-sm space-y-1">
                  <p>BINARY BRAINS</p>
                  <a href="mailto:hello@binarybrains.co.uk" className="underline">hello@binarybrains.co.uk</a>
                </div>
              </div>
